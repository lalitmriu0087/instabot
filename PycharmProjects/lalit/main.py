...
STATUS_MESSAGES = ['Lets make a plan to goa, lets ride out', 'Plan cancelled, Not confirm ', 'We r mad, select one of above']

friends = []

print "Welcome to the world of maddness."
...
def add_friend():
    ...
    new_friend.salutation = raw_input("Are they Chora or Chori?: ")
...
if existing == "Y":
    ...
    if len(spy.name) > 0:
        spy.salutation= raw_input("Should I call you Chora. or Chori. ?: ")
